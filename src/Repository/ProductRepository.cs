...
using UtilsSortOrder = SDA_Backend_Project.src.Utils.SortOrder;
...
namespace SDA_Backend_Project.src.Repository
{
    public class ProductRepository
    {
        ...
        public async Task<List<Product>> GetProductsBySubCategoryIdAsync(string subCategoryName)
        {
            return await _products
        ...
        public async Task<List<Product>> GetAllBySortAsync(SortOptions sortOption)
        {
            ...
            if (!string.IsNullOrEmpty(sortOption.SortBy))
            {
                ...
                {
                    query =
                        sortOption.SortOrder == UtilsSortOrder.Descending
        ...
        )
        {
            ...
            if (!string.IsNullOrEmpty(toSearch.SortBy))
            {
                ...
                {
                    query =
                        toSearch.SortOrder == UtilsSortOrder.Descending
                            ? query.OrderByDescending(x => x.ProductPrice)
                            : query.OrderBy(x => x.ProductPrice);
                }
