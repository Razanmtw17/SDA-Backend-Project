...
namespace SDA_Backend_Project.src.Services.Order
{
    public class OrderService : IOrderService
    {
       protected readonly OrderRepository _orderRepository;
        ...
        {
            var order = _mapper.Map<OrderCreateDTO, SDA_Backend_Project.src.Entity.Order>(createDTO);
            ...
            return _mapper.Map<SDA_Backend_Project.src.Entity.Order, OrderReadDTO>(orderCreated);
        }
        ...
        public async Task<List<OrderReadDTO>> GetAllAsync(PaginationOptions paginationOptions)
        {
            ...
            return _mapper.Map<List<SDA_Backend_Project.src.Entity.Order>, List<OrderReadDTO>>(orderList);
        }
        ...
        public async Task<OrderReadDTO> GetByIdAsync(Guid id)
        {
            ...
            return _mapper.Map<SDA_Backend_Project.src.Entity.Order, OrderReadDTO>(foundOrder);
        }
        ...
        public async Task<List<OrderReadDTO>> GetByUserIdAsync(Guid userId, PaginationOptions paginationOptions)
        {
            ...
            return _mapper.Map<List<SDA_Backend_Project.src.Entity.Order>, List<OrderReadDTO>>(ordersList);
        }
